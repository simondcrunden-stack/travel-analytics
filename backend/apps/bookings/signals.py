...
# =============================================================================
# SIGNAL 5: Sub-Booking Changes → Update Parent Booking Totals
# =============================================================================
...
def update_booking_totals(sender, instance, created, **kwargs):
    ...
    if instance.booking:
        try:
            ...
            # Calculate total from all sub-bookings
            total = Decimal('0.00')
            
            # Sum air bookings - uses total_fare field
            ...
            # Sum accommodation bookings - uses total_amount_base field
            ...
            # Sum car hire bookings - uses total_amount_base field
...
# @receiver(post_save, sender='bookings.CarHireBooking')
# =============================================================================
# SESSION 37 FIX: TEMPORARILY DISABLED - ComplianceAlert model not created yet
# =============================================================================
# @receiver(post_save, sender='bookings.AccommodationBooking')
# @receiver(post_save, sender='bookings.CarHireBooking')
...
#     
#     NOTE: This signal is disabled until ComplianceAlert model is created.
#     """
#     pass
#     # Full implementation commented out below:
#     """
